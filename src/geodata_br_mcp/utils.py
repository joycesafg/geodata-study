...
def get_feature_bounds(feature: Dict[str, Any]) -> Optional[Tuple[float, float, float, float]]:
...
def validate_geojson_structure(data: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
